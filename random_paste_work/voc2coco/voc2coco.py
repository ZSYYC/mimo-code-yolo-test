...
# https://blog.csdn.net/weixin_45921929/article/details/127940596
# |__voc2coco.py
# |__VOC
...
if __name__ == '__main__':
    ...
    testRatio = 0.2
    # 获取当前脚本路径
    main_path = '/home/yaoteam/yaoteam/wz/voc2coco/'
    print(main_path)
    # voc格式的图片和xml存放路径
    voc_images = os.path.join(main_path, 'VOC', 'JPGImages')
    ...
    coco_train2017 = os.path.join(main_path, 'COCO', 'small_insect_train')
    coco_val2017 = os.path.join(main_path, 'COCO', 'small_insect_val')
    coco_test2017 = os.path.join(main_path, 'COCO', 'small_insect_test')
    xml_val = os.path.join(main_path, 'xml', 'small_insect_xml_val')
    xml_test = os.path.join(main_path, 'xml', 'small_insect_xml_test')
    xml_train = os.path.join(main_path, 'xml', 'small_insect_xml_train')
    ...
    convert(xml_val_files, os.path.join(coco_json_annotations, 'small_insect_val.json'))

    convert(xml_train_files, os.path.join(coco_json_annotations, 'small_insect_train.json'))
    if testRatio:
        convert(xml_test_files, os.path.join(coco_json_annotations, 'small_insect_test.json'))
