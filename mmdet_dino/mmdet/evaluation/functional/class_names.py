...
def cityscapes_classes() -> list:
    """Class names of mix9_bug."""
    return [
        'Chilo-suppressalis', 'Macroceroea-grandis-Gray', 'Rice-leaf-folder', 'Sesamia-inferens', 'Sirthenea-flavipes', 'brown-planthopper', 'lacewing-fly', 'small-brown-planthopper', 'white-backed-planthopper'
    ]
