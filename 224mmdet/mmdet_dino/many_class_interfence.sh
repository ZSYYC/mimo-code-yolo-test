...
# 设置输入文件夹和输出文件夹的路径
INPUT_DIR="/home/yaoteam/yaoteam/yyc/mmdet_dino/单种虫子数据集0523"
OUTPUT_DIR="/home/yaoteam/yaoteam/yyc/mmdet_dino/outputs"

# 设置其他固定参数
SCRIPT_PATH="cebaodengft0512/grounding_dino_swin-t_finetune_8xb4_20e_cat.py"
