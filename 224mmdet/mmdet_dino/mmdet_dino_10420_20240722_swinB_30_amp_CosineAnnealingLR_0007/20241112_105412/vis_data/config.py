...
coco_od_dataset = dict(
    ...
    return_classes=True,
    type='ODVGDataset')
data_root = '/home/star/yyc/datasets/分离出来的数据集0616_10000/images_sahi1_sam1/'
dataset_10000 = dict(
...
launcher = 'none'
load_from = 'mmdet_dino_10420_20240722_swinB_30_amp_CosineAnnealingLR_0007/best_coco_bbox_mAP_epoch_25.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='images/'),
        data_root=
        '/home/star/yyc/datasets/分离出来的数据集0616_10000/images_sahi1_sam1/',
        metainfo=dict(classes=('insect', ), palette=[
            (
                220,
                20,
...
test_evaluator = dict(
    ann_file=
    '/home/star/yyc/datasets/分离出来的数据集0616_10000/images_sahi1_sam1/annotations/val2017.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
