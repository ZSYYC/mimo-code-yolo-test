...
# 设置路径
json_dir = '/home/yaoteam/yaoteam/yyc/mmdet_dino/outputs_罗浩伦小虫数据集/preds'
img_dir = '/home/yaoteam/yaoteam/yyc/random_paste_work/虫情测报灯罗浩伦数据集/VOC/JPEGImages'
output_dir = '/home/yaoteam/yaoteam/yyc/mmdet_dino/所有图片VOC标注文件/罗浩伦小虫数据集'
