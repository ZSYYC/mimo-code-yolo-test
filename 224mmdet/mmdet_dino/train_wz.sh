...
torchrun --nproc_per_node 4 --master_port=25641 tools/train.py configs/mm_grounding_dino/grounding_dino_swin-t_finetune_8xb4_20e_cat.py --work-dir /home/star/2T-new/wz/groundingdino微调/ --auto-scale-lr --launcher 'pytorch' --amp
